      ...
      >
        {selectedAlert && (
          <div className="space-y-6 text-xs">
            {/* Status, Priority, Confidence Strip + Analyst Decision Actions (Feature 3) */}
            <div className="p-3.5 rounded-xl bg-[#f9fafb] border border-[#e5e5e5] space-y-3">
              <div className="grid grid-cols-3 gap-3">
                <div>
                  <span className="text-[11px] text-[#737373] block font-medium">Current Status</span>
                  <div className="mt-1">
                    <span
